...
<script src="{{asset('template/dist/assets/vendors/jvectormap/jquery-jvectormap.min.js')}}"></script>
<script src="{{asset('template/dist/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
<script src="{{asset('template/dist/assets/vendors/owl-carousel-2/owl.carousel.min.js')}}"></script>
...
<!-- <script src="{{asset('template/dist/assets/js/proBanner.js')}}"></script> -->
