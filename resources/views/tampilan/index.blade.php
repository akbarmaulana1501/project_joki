                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row justify-content-between">
                                    <h4 class="card-title mb-1">Project yang sedang Tersedia</h4>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="preview-list">
                                            ...
                                            <div class="preview-item border-bottom">
                                                ...
                                                <div class="preview-item-content d-sm-flex flex-grow">
                                                    <div class="flex-grow">
                                                        <h6 class="preview-subject">{{ $proj->nm_project }}</h6>
                                                        <p class="text-muted mb-0">{{ $proj->deskripsi }}</p>
                                                    </div>
                                                    <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                                        <p class="text-muted">{{ $proj->created_at->diffForHumans() }}</p>
                                                        <p class="text-muted mb-0">Handle By : <strong>{{ $proj->handle_name }}</strong></p>
                                                        @if (!empty($proj->status))
                                                        <p class="text-muted mb-0">Status : <strong>{{ $proj->status }}</strong></p>
                                                        @elseif (empty($proj->status))
                                                        <p class="text-muted mb-0">Status : <strong>None</strong></p>
                                                        @else
                                                        <p class="text-muted mb-0">Status : <strong>{{ $proj->status }}</strong></p>
                                                        @endif
                                                    </div>
