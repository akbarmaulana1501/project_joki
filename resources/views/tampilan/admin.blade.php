                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $user->name }}</td> <!-- Nama Lengkap -->
                                                <td>{{ $user->email }}</td> <!-- Email -->
                                                <td>{{ $user->no_hp }}</td> <!-- Nomor Telepon -->
                                                <td>{{ $user->alamat }}</td> <!-- Alamat -->
                                                <td>
                                                    @if($user->role == 'admin')
                                                    <p class="btn btn-danger">Admin</p> <!-- Tombol Merah untuk Admin -->
                                                    @else
                                                    <p class="btn btn-success">User</p> <!-- Tombol Hijau untuk User -->
                                                    @endif
                                                </td> <!-- Status -->
                                            </tr>
                                            @endforeach
