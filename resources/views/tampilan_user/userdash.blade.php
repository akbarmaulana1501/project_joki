                                            ...
                                            <div class="preview-item border-bottom">
                                                ...
                                                <div class="preview-item-content d-sm-flex flex-grow">
                                                    ...
                                                    <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                                        ...
                                                        @if(is_null($proj->handle_name) && Auth::user()->role === 'user')
                                                        <div class="d-flex justify-content-end mt-2">
                                                            <form action="{{ route('ambil_project', $proj->id) }}" method="POST">
                                                                @csrf
                                                ...
                                                <!-- Tombol Ambil hanya muncul jika handle_name kosong dan role user adalah 'user' -->
